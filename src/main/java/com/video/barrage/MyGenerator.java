...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/video?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false");
        ...
        pc.setParent("com.video.barrage");//你哪个父目录下创建包
